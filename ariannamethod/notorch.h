...
#define NT_OP_MH_BIDIR_ATTN 24   // multi-head BIDIRECTIONAL self-attention (for diffusion)
...
// Multi-head BIDIRECTIONAL self-attention (no causal mask — for diffusion models)
